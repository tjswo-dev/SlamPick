...
const SERVICES: ServiceData[] = [
  {
    ...
    summary: "OWM 약국에 방문해서 OWM에서 구매해야 하는 필수템으로 제품을 소개합니다.",
    detail: {
      description:
        "OWM 약국에 직접 방문하여 브랜드 제품을 'OWM에서 꼭 사야 하는 필수템'으로 소개하는 콘텐츠입니다.\n공간과 제품을 함께 담아 소비자가 자연스럽게 OWM을 방문하고 싶게 만드는 인바운드 유입 전략입니다.",
      points: [
        { label: "주요 거점", value: "OWM 약국 매장" },
        { label: "콘텐츠 전략", value: "OWM 필수템 소개 · 매장 탐방 · 약사 추천 픽업" },
        { label: "기대 효과", value: "OWM 방문 욕구 자극 → 자발적 인바운드 고객 증대" },
      ],
      effect:
        "OWM을 '꼭 가야 할 약국'으로 포지셔닝하여 브랜드 제품과 함께 자발적 방문 고객을 증대",
      videoUrls: [
  ...
  },
  {
    ...
    summary: "OWM 매대 진열 사진과 영상을 현지 시딩 콘텐츠에 포함시켜 CTA를 OWM으로 자연스럽게 연결합니다.",
    detail: {
      description:
        "브랜드 시딩 콘텐츠에 OWM 매대 진열 사진과 OWM 매장 영상을 함께 제공하여 콘텐츠 안에 OWM이 자연스럽게 노출되도록 합니다.\n크리에이터의 콘텐츠 CTA를 OWM 구매로 연결해, 시딩 효과와 오프라인 유입을 동시에 만들어냅니다.",
      points: [],
      effect:
        "현지 시딩 콘텐츠와 OWM을 연결하여 인지도 확산과 오프라인 구매 전환을 동시에 달성합니다.",
      tiers: [
        {
          level: "나노급",
          badge: "RISING NANO",
      ...
      subCategories: [
        {
          title: "약사 신뢰형 콘텐츠",
          description:
            "약사 크리에이터가 제품의 성분과 효과를 설명하며 추천하는 콘텐츠입니다.",
          videoUrls: [
        ...
        },
        {
          title: "피부과 연계 콘텐츠",
          description:
            "피부과 시술 후 키워드를 제품의 소구점과 연결합니다.\n시술 후 저자극 · 시술 후 케어 · 시술 후 유지 등으로 키워드를 잡고, 리쥬란·울쎄라 등 피부과 시술과 브랜드 제품을 함께 진행하는 콘텐츠입니다.",
          videoUrls: [
