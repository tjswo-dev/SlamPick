...
const SERVICES: ServiceData[] = [
  {
    ...
    detail: {
      description:
        "크리에이터가 OWM 약국을 직접 방문하여 매장 공간과 분위기를 담고, 브랜드 제품을 'OWM에서 구매해야 하는 필수템'으로 자연스럽게 소개하는 콘텐츠입니다.\n단순한 제품 광고를 넘어 OWM이라는 프리미엄 공간과 브랜드를 함께 연결함으로써, 소비자가 '저기 한번 가봐야겠다'는 인바운드 방문 욕구를 갖게 만드는 것이 핵심 전략입니다.",
      points: [
        { label: "주요 거점", value: "OWM 약국 매장" },
        { label: "콘텐츠 전략", value: "매장 탐방 · 약사 추천 픽업 · OWM 필수템 소개" },
        { label: "소비자 반응", value: "정보 저장 · 가볼만한 장소 · '저거 사러 가야지'" },
      ],
      effect:
        "단순 제품 홍보를 넘어 OWM 약국 자체를 하나의 콘텐츠 목적지로 만드는 전략입니다. 공간의 전문성과 신뢰감이 제품에 자연스럽게 이식되어 소비자가 광고가 아닌 정보로 받아들이며, 자발적 방문 고객 증대와 오프라인 매출 상승을 동시에 이끌어냅니다.",
      videoUrls: [
  ...
  },
  {
    ...
    detail: {
      description:
        "브랜드 시딩을 진행할 때 제품과 함께 OWM 매대 진열 사진과 매장 영상을 현지 크리에이터에게 제공합니다. 크리에이터는 이를 콘텐츠에 자연스럽게 녹여내고, 마지막 CTA를 'OWM에서 구매하기'로 연결합니다.\n현지 시딩의 바이럴 도달 효과에 OWM이라는 명확한 구매 목적지를 결합해, '보고 끝'이 아니라 '보고 사러 간다'는 소비 행동 전환을 만들어내는 전략입니다.",
      points: [],
      effect:
  ...
  },
  {
    ...
    summary: "약사 크리에이터와 피부과 전문의 채널을 활용해 제품의 성분·효능을 전문가 시각으로 전달합니다. 소비자가 광고가 아닌 정보로 받아들여 구매 확신을 높입니다.",
    detail: {
      description:
        "소비자들은 일반 인플루언서보다 전문가의 추천을 훨씬 높은 신뢰도로 받아들입니다. 약사 크리에이터와 피부과 채널은 팔로워 수가 적어도 구매 전환율이 압도적으로 높은 이유가 바로 여기에 있습니다.\n전문가의 공신력을 브랜드 제품에 이식하는 방식으로, 건강기능식품·더마 코스메틱·의약외품 카테고리에서 특히 강력한 효과를 발휘합니다.",
      points: [
        { label: "콘텐츠 주체", value: "약사 크리에이터 · 피부과 전문의 · 전문 기관 채널" },
        { label: "핵심 전략", value: "성분·효능 팩트 기반 설명 + 전문가 직접 추천" },
        { label: "적합 카테고리", value: "건강기능식품 · 더마 코스메틱 · 의약외품 · 선케어" },
      ],
      effect:
        "전문가의 공신력이 제품에 이식되어, 소비자가 '이 제품은 달라'는 확신을 갖게 됩니다. 팔로워 수보다 신뢰도가 구매를 결정하는 카테고리에서 가장 높은 ROI를 기대할 수 있는 콘텐츠 유형입니다.",
      subCategories: [
        {
          title: "약사 신뢰형 콘텐츠",
          description:
            "약사 크리에이터가 제품의 성분과 효과를 직접 설명하며 추천하는 콘텐츠입니다.\n'약사가 직접 추천한다'는 한 마디가 소비자의 구매 결정을 강하게 이끕니다. 건강기능식품·더마 코스메틱처럼 성분 신뢰가 구매의 핵심인 카테고리에서 일반 인플루언서 대비 월등히 높은 전환율을 보입니다.",
          videoUrls: [
        ...
        },
        {
          title: "피부과 연계 콘텐츠",
          description:
            "피부과 시술 직후는 소비자의 스킨케어 관심도가 가장 높아지는 순간입니다. 이 타이밍에 '시술 후 저자극 · 시술 후 케어 · 시술 후 유지' 키워드로 제품 소구점을 자연스럽게 연결합니다.\n리쥬란·울쎄라·보톡스 등 구체적인 시술명과 브랜드 제품을 함께 언급해, '이 시술을 받았다면 이 제품이 필요하다'는 소비자의 구매 당위성을 만들어냅니다.",
          videoUrls: [
  ...
  },
  {
    ...
    summary: "브랜드 제품을 단독 광고가 아닌 여러 제품 중 하나로 자연스럽게 노출합니다. 소비자는 광고인 줄 모르고, 직접 찾아서 사는 경험을 하게 됩니다.",
    detail: {
      description:
        "한 가지 제품만 강조하는 단독 광고 방식이 아니라, 여러 카테고리의 제품을 하나의 콘텐츠에 자연스럽게 묶어 큐레이션합니다. 소비자 입장에서는 '이 사람이 진짜 쓰는 것들을 공유하는구나'라고 느끼게 되어 광고 거부감이 현저히 낮아집니다.\n특히 추천 리스트·하울·일상 브이로그 형태로 제작되어, 소비자가 콘텐츠를 저장하고 나중에 직접 찾아서 구매하는 자발적 전환이 높게 나타납니다.",
      points: [
        { label: "노출 방식", value: "단독 광고가 아닌 여러 제품 중 하나로 자연스럽게 포함" },
        { label: "핵심 전략", value: "광고 거부감 최소화 · '찐 후기'처럼 인식되는 자연스러운 노출" },
        { label: "콘텐츠 형태", value: "추천 리스트 · 하울 · 일상 브이로그 · 템 소개" },
      ],
      effect:
        "소비자가 광고임을 인지하지 못한 채 자연스럽게 제품에 노출되고, 콘텐츠를 저장하거나 나중에 직접 검색해 구매하는 자발적 전환으로 이어집니다. 단독 광고 대비 거부감이 낮아 장기적인 브랜드 호감도 형성에도 효과적입니다.",
      videoUrls: [
