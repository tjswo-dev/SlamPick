...
const SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    summary: "약사 크리에이터가 제품의 성분과 효과를 직접 설명하며 추천합니다. '약사가 추천한다'는 한 마디가 소비자의 구매 결정을 강하게 이끌어냅니다.",
    detail: {
      description:
        "소비자들은 일반 인플루언서보다 약사의 추천을 훨씬 높은 신뢰도로 받아들입니다. 약사 크리에이터가 제품의 성분과 효과를 직접 설명하고 추천하는 방식으로, 팔로워 수가 적어도 구매 전환율이 압도적으로 높습니다.\n건강기능식품·더마 코스메틱처럼 성분 신뢰가 구매의 핵심인 카테고리에서 일반 인플루언서 대비 월등히 높은 ROI를 기대할 수 있습니다.",
      points: [
        { label: "콘텐츠 주체", value: "약사 크리에이터 · 약국 공식 채널" },
        { label: "핵심 전략", value: "성분·효능 팩트 기반 설명 + 약사 직접 추천" },
        { label: "적합 카테고리", value: "건강기능식품 · 더마 코스메틱 · 의약외품" },
      ],
      effect:
        "약사의 공신력이 제품에 이식되어 소비자가 '이 제품은 달라'는 확신을 갖게 됩니다. 광고가 아닌 전문가 정보로 받아들여 구매 저항이 낮고, 장기적인 브랜드 신뢰도 구축에도 효과적입니다.",
      videoUrls: [
  ...
  },
  {
    ...
    summary: "피부과 시술 후 키워드를 제품 소구점과 연결합니다. 시술 직후 높아진 스킨케어 관심을 브랜드 구매로 자연스럽게 이어줍니다.",
    detail: {
      description:
      ...
      effect:
        "시술 직후의 높아진 스킨케어 니즈를 브랜드 제품으로 연결해 자연스러운 구매 당위성을 만들어냅니다. 소비자가 '지금 내 피부에 딱 맞는 제품'이라고 느끼게 하여 구매 전환율과 브랜드 충성도를 동시에 높입니다.",
      videoUrls: [
